 ...
 */
int thr_pool_init(thr_pool_t *tpp, uint_t t_num_min, uint_t t_num_max, int timeout_sec, pthread_attr_t *attr UNUSED)
{
	TP_BLOCK_ALLSIG();
	ERR_CLEAN_INIT();
